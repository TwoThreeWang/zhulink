...
- **纯垃圾广告**：毫无信息增量的博彩、灰产、纯SEO堆砌内容（注：包含具体技术参数、行业动态、技术解析或产品重大更新的商业/产品新闻**不在**此列，应正常处理）。
...
# Tasks
1. 评估内容属性。当内容属于【纯垃圾广告】（如博彩、灰产、纯 SEO 堆砌、无任何有效信息增量的纯营销推销等）时，请**直接且仅**返回字符串 "AD"。
   - **注意**：包含行业动态、技术解析、重要产品更新或具有技术讨论价值的新闻**不属于**广告，应作为正常内容处理。
