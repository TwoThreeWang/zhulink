...
func RegisterRoutes(r *gin.Engine) {
	...
	r.GET("/sitemap.xml", seoHandler.SitemapIndex) // sitemap index
	r.GET("/sitemap-static.xml", seoHandler.SitemapStaticXML)
	r.GET("/sitemap-posts/:page", seoHandler.SitemapPostsXML)
