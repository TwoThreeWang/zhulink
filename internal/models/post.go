...
const (
	PostIndexStatusIndexable = "indexable"
	PostIndexStatusNoIndex   = "noindex"
	PostIndexStatusBlocked   = "blocked"
)
...
type Post struct {
	...
	IndexStatus    string           `gorm:"size:20;default:'indexable';index" json:"index_status"`
